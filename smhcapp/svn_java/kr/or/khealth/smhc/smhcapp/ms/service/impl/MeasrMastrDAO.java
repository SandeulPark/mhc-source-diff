...
public class MeasrMastrDAO extends DMultiEgovAbstractMapper{
	...
	public int insertSleep(Map<String, Object> param) throws Exception {
		
		return insert("mhc.app.ms.measrmas.insertSleep", param);			  
	}
	
	public int updatePairDeviceInfo(Map<String, Object> param) throws Exception {
		
		return insert("mhc.app.ms.measrmas.updatePairDeviceInfo", param);	  
	}
	...
	public int updateLstBloodSugar(Map<String, Object> param) throws Exception {
		return update("mhc.app.ms.measrmas.updateLstBloodSugar", param);
	}
	
	public Map<String, Object> getMeasureResultInf(Map<String, Object> param) throws Exception{
		return selectOne("mhc.app.ms.measrmas.getMeasureResultInf", param);
	}

	public Map<String, Object> lstBloodSugarSaveChk(Map<String, Object> param) throws Exception{
		// TODO Auto-generated method stub
		return selectOne("mhc.app.ms.measrmas.lstBloodSugarSaveChk", param);
	}

	public int updateLstBloodSugarClf(Map<String, Object> param) throws Exception{
		// TODO Auto-generated method stub
		return update("mhc.app.ms.measrmas.updateLstBloodSugarClf", param);
	}

	public Map<String, Object> selectPedometerLstData(Map<String, Object> param) {
		// TODO Auto-generated method stub
		return selectOne("mhc.app.ms.measrmas.selectPedometerLstData", param);
	}

	public Map<String, Object> selectBodyCompLstData(Map<String, Object> param) {
		// TODO Auto-generated method stub
		return null;
	}

	public Map<String, Object> selectBloodSugarLstData(Map<String, Object> param) {
		// TODO Auto-generated method stub
		return selectOne("mhc.app.ms.measrmas.selectBloodSugarLstData", param);
	}

	public Map<String, Object> selectBloodPressLstData(Map<String, Object> param) {
		// TODO Auto-generated method stub
		return selectOne("mhc.app.ms.measrmas.selectBloodPressLstData", param);
	}

	public int chkBloodSugarLstData(Map<String, Object> param) {
		// TODO Auto-generated method stub
		return selectOne("mhc.app.ms.measrmas.chkBloodSugarLstData", param);
	}

	public int chkBloodPressLstData(Map<String, Object> param) {
		// TODO Auto-generated method stub
		return selectOne("mhc.app.ms.measrmas.chkBloodPressLstData", param);
	}
	
	public void insertActDataErrHis(Map<String, Object> rsMap) {
		// TODO Auto-generated method stub
		insert("mhc.app.ms.measrmas.insertActDataErrHis", rsMap);
	}
	
	public Map<String, Object> getUserInfoForActErr(Map<String, Object> insMap) {		
		return selectOne("mhc.app.ms.measrmas.getUserInfoForActErr", insMap);
	}
