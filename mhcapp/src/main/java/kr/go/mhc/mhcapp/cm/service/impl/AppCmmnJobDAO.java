...
public class AppCmmnJobDAO extends DMultiEgovAbstractMapper{
	...
	public int insertNoticePopYn(Map<String, Object> param) throws Exception{
		int rsList = insert("mhcapp.cm.appcmmnjob.insertNoticePopYn", param);
		return rsList;
	}
	 ...
	 * @throws Exception
	 */
	public List<Map<String, String>> selectMyInfoTrgtServey(Map<String, Object> param)
			throws Exception {
		// TODO Auto-generated method stub
		List<Map<String,String>> rsList = selectList("mhcapp.cm.appcmmnjob.selectMyInfoTrgtServey", param);
		return rsList;
	}
