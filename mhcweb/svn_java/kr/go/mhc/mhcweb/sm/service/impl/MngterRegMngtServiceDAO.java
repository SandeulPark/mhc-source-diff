...
/**
 * @Class Name : MngterRegMngtServiceDAO.java
...
@Repository("web.sm.MngterRegMngtServiceDAO")
public class MngterRegMngtServiceDAO extends DMultiEgovAbstractMapper{
	...
	public List<Map<String, String>> getRegMngterList(Map<String, Object> param) throws Exception {
		List<Map<String,String>> rsList = selectList("mhc.web.sm.mngterregmngt.selectRegMngterList", param);	
		return rsList;  
	}
	...
	public int saveMngter(Map<String, Object> param) throws Exception {
		...
		if(param.get("USER_ID").equals("")){
			...
			rsInt = insert("mhc.web.sm.mngterregmngt.insertUserInfo", param);
			...
			rsInt = update("mhc.web.sm.mngterregmngt.updateUserInfo", param);
		...
		rsInt += update("mhc.web.sm.mngterregmngt.saveManagerAuth", param);
	...
	public Map<String, Object> getManagerDuplicationCnt(Map<String, Object> param) throws Exception {
		...
		Map<String,Object> rsMap = selectOne("mhc.web.sm.mngterregmngt.selectManagerDuplicationCnt",param);	
		return rsMap;
	}
	...
	public int updateApprovalYn(Map<String, Object> param) throws Exception {
		int rsInt = update("mhc.web.sm.mngterregmngt.updateApprovalYn", param);		
		return rsInt;
	}
	...
	public int updatedn1Use(Map<String, Object> param) throws Exception {
		int rsInt = update("mhc.web.sm.mngterregmngt.updatedn1Use", param);		
		return rsInt;
	}
	...
	public int updatedn2Use(Map<String, Object> param) throws Exception {
		int rsInt = update("mhc.web.sm.mngterregmngt.updatedn2Use", param);		
		return rsInt;
	}
	/**
	 * 관리자 팝업 데이터 조회 조회
	...
	public Map<String, Object> getdigiSignPopUp(Map<String, Object> param) throws Exception {
		Map<String,Object> rsMap = selectOne("mhc.web.sm.mngterregmngt.selectDignSigninfo", param);	
		return rsMap;
	}
	...
	public List<Map<String, String>> permissionsList(Map<String, Object> param) throws Exception {		
		List<Map<String,String>> rsList = selectList("mhc.web.sm.mngterregmngt.permissionsList", param);		
		return rsList;  
	}
	...
	public List<Map<String, String>> userAuthList(Map<String, Object> param) throws Exception {		
		List<Map<String,String>> rsList = selectList("mhc.web.sm.mngterregmngt.userAuthList", param);		
		return rsList;  
	}
	...
	public List<Map<String, String>> permissionsTrgterList(Map<String, Object> param) throws Exception {		
		List<Map<String,String>> rsList = selectList("mhc.web.sm.mngterregmngt.permissionsTrgterList", param);		
		return rsList;  
	}
	...
	public List<Map<String, String>> perMenuList(Map<String, Object> param) throws Exception {		
		List<Map<String,String>> rsList = selectList("mhc.web.sm.mngterregmngt.perMenuList", param);		
		return rsList;  
	}
	...
	public List<Map<String, String>> selectPerMenuList(Map<String, Object> param) throws Exception {		
		List<Map<String,String>> rsList = selectList("mhc.web.sm.mngterregmngt.selectPerMenuList", param);		
		return rsList;  
	}
	...
	public List<Map<String, String>> selectAuthKey(Map<String, Object> param) throws Exception {		
		List<Map<String,String>> rsList = selectList("mhc.web.sm.mngterregmngt.selectAuthKey", param);		
		return rsList;  
	}
	...
	public List<Map<String, String>> selectPerMenuCnt(Map<String, Object> param) throws Exception {		
		List<Map<String,String>> rsList = selectList("mhc.web.sm.mngterregmngt.selectPerMenuCnt", param);		
		return rsList;  
	}
	...
	public void perMenuGInsert(Map<String, Object> param) throws Exception {
		insert("mhc.web.sm.mngterregmngt.perMenuGInsert", param);
	}
	...
	public void authListInsert(Map<String, Object> param) throws Exception {
		insert("mhc.web.sm.mngterregmngt.authListInsert", param);
	}
	...
	public void authListUpdate(Map<String, Object> param) throws Exception {
		insert("mhc.web.sm.mngterregmngt.authListUpdate", param);
	}
	...
	public void authListUpdate2(Map<String, Object> param) throws Exception {
		insert("mhc.web.sm.mngterregmngt.authListUpdate2", param);
	}
	...
	public void authDelete(Map<String, Object> param) throws Exception {
		delete("mhc.web.sm.mngterregmngt.authDelete", param);
	}
	...
	public void authList(Map<String, Object> param) throws Exception {
		delete("mhc.web.sm.mngterregmngt.authList", param);
	}
	...
	public void userAuthDelete(Map<String, Object> param) throws Exception {
		delete("mhc.web.sm.mngterregmngt.userAuthDelete", param);
	}
	...
	public void orgAuthUsersInsert(Map<String, Object> param) throws Exception {
		insert("mhc.web.sm.mngterregmngt.orgAuthUsersInsert", param);
	}
	...
	public List<Map<String, String>> userPerCheck(Map<String, Object> param) throws Exception {		
		List<Map<String,String>> rsList = selectList("mhc.web.sm.mngterregmngt.userPerCheck", param);		
		return rsList;  
	}
	
	public List<Map<String, Object>> getOrgAuthList(Map<String, Object> param) throws Exception{
		List<Map<String, Object>> rsList = selectList("mhc.web.sm.mngterregmngt.selectRegMngterList2", param);
		return rsList;
	}
	
	public List<Map<String, Object>> slectErrReport(Map<String, Object> param) throws Exception{
		List<Map<String, Object>> rsList = selectList("mhc.web.sm.mngterregmngt.slectErrReport", param);
		return rsList;
	}
	
	public List<Map<String, Object>> checkRegUser(Map<String, Object> param) throws Exception{
		List<Map<String, Object>> rsList = selectList("mhc.web.sm.mngterregmngt.checkRegUser", param);
		return rsList;
	}
}
