...
@Repository("web.mr.MealDiaryRegDAO")
public class MealDiaryRegDAO extends EgovAbstractMapper {
	
	//식단등록 목록 조회
	public List<Map<String, Object>> getMealDiaryRegList(Map<String, Object> param) throws Exception {
		List<Map<String, Object>> rsList = selectList("mhc.web.mr.mealdiaryreg.selectMealDiaryRegList", param);
		return rsList;
	}
	...
	public List<Map<String, Object>> getMealDiaryExcel(Map<String, Object> param) throws Exception {
		List<Map<String, Object>> rsList = selectList("mhc.web.mr.mealdiaryreg.selectMealDiaryExcelList", param);
		return rsList;
	}
}
