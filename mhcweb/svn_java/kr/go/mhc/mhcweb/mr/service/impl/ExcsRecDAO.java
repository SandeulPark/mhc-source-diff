...
@Repository("web.mr.ExcsRecDAO")
public class ExcsRecDAO extends EgovAbstractMapper {

	//서비스 참여 정보 목록 조회
	public List<Map<String, Object>> selectExcsRecList(Map<String, Object> param) throws Exception {
		List<Map<String, Object>> rsList = selectList("mhc.web.mr.excsrec.selectExcsRecList", param);
		return rsList;
	}
}
