...
@Repository("web.mr.SportActivityDAO")
public class SportActivityDAO extends EgovAbstractMapper{

	public List<Map<String, Object>> getSportActivityUserList(Map<String, Object> param) {
		// TODO Auto-generated method stub
		List<Map<String, Object>> rsList = selectList("mhc.web.mr.sportactivity.getSportActivityUserList", param);
		return rsList;
	}

	public Map<String, Object> getSportActivityCertMsg(Map<String, Object> param) {
		// TODO Auto-generated method stub
		Map<String, Object> rsMap = selectOne("mhc.web.mr.sportactivity.selectSportActivityCertMsg", param);
		return rsMap;
	}
	
	public Map<String, Object> userInfo(String param) {	
		Map<String, Object> rsMap = new HashMap<String, Object>();
		rsMap = selectOne("mhc.web.mr.sportactivity.getUserInfo",param);
