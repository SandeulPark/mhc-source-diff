...
public class CmntyGSetController extends DMultiActionController{

	@Resource(name = "web.sv.CmntyGSetService")
	private CmntyGSetService cmntyGSetService;
	...
	public @ResponseBody Map<String, Object> cmntyGList(HttpServletRequest request, @ModelAttribute Map<String, Object> param, ModelMap model) throws Exception {
		...
		param.put("CMMN_DTLS_CD", param.get("CMNTY_CD"));
		param.put("CMMN_CD", "TC_CM_ORG_CHRONIC");
		List<Map<String,String>> isChronicOrg = cmmnService.selectCmmnCd(param);

		Map<String, Object> rsMap = new HashMap<String, Object>();		
		List<Map<String, String>> rsList = cmntyGSetService.getCmntyGList(param);
		rsMap.put("rsList", rsList);
		rsMap.put("id", param.get("id"));	
		rsMap.put("gridTotalRowCount", null);
		rsMap.put("isChronicOrg", isChronicOrg);
		return rsMap;
	}
	...
	public @ResponseBody Map<String, Object> cmntyGTrgterList( @ModelAttribute Map<String, Object> param, ModelMap model) throws Exception {
		Map<String, Object> rsMap = new HashMap<String, Object>();		
		List<Map<String, String>> rsList = cmntyGSetService.getCmntyGTrgterList(param);
		rsMap.put("rsList", rsList);
		rsMap.put("id", param.get("id"));
		return rsMap;
	}
	...
	public @ResponseBody Map<String,Object> newCmntyGSn( @ModelAttribute Map<String, Object> param, ModelMap model) throws Exception {
		Map<String,Object> rsMap = cmntyGSetService.getNewCmntyGSn(param);
		return rsMap;
	}
	...
	public String cmntyGSetPop(@ModelAttribute Map param, ModelMap model) throws Exception {
		List<Map<String,String>> gclasList = cmntyGSetService.getGclasList();
		model.addAttribute("gclasList",gclasList);
		return "web/sv/cmntyGSetPop";
	}
	...
	public @ResponseBody Map<String, Object> cmntyGInsert(@ModelAttribute Map<String, Object> param, ModelMap model) throws Exception {
		cmntyGSetService.getCmntyGInsert(param);
		Map<String, Object> rsMap = new HashMap<String, Object>();		
		List<Map<String, String>> rsList = cmntyGSetService.getCmntyGList(param);
		rsMap.put("rsList", rsList);
		rsMap.put("id", param.get("id"));		
	...
	public @ResponseBody Map<String, Object> cmntyGUpd(@ModelAttribute Map<String, Object> param, ModelMap model) throws Exception {
		cmntyGSetService.getCmntyGUpd(param);
		Map<String, Object> rsMap = new HashMap<String, Object>();		
		List<Map<String, String>> rsList = cmntyGSetService.getCmntyGList(param);
		rsMap.put("rsList", rsList);
		rsMap.put("id", param.get("id"));		
	 ...
	 * @throws Exception 
	 */
	@RequestMapping(value = "/cmntyGDel.do", method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> cmntyGDel(HttpServletRequest request, @ModelAttribute Map<String, Object> param, ModelMap model) throws Exception {
		...
		//cmntyGSetService.getCmntyGUseN(param);
		Map<String, Object> rsMap = new HashMap<String, Object>();				
		//그룹 삭제
		cmntyGSetService.delCmntyGroup(param);
		//대상자 삭제
		cmntyGSetService.delCmntyGroupMember(param);
	...
	public @ResponseBody Map<String, Object> cmntyGTrgterUseN(@ModelAttribute Map<String, Object> param, ModelMap model) throws Exception {
		cmntyGSetService.getCmntyGTrgterUseN(param);
		Map<String, Object> rsMap = new HashMap<String, Object>();		
		List<Map<String, String>> rsList = cmntyGSetService.getCmntyGTrgterList(param);
		rsMap.put("rsList", rsList);
		rsMap.put("id", param.get("id"));		
	...
	public @ResponseBody Map<String, Object> cmntyGTrgterInsert(@ModelAttribute Map<String, Object> param, ModelMap model) throws Exception {
		cmntyGSetService.getCmntyGTrgterInsert(param);
		Map<String, Object> rsMap = new HashMap<String, Object>();		
		List<Map<String, String>> rsList = cmntyGSetService.getCmntyGList(param);
		rsMap.put("rsList", rsList);
		rsMap.put("id", param.get("id"));		
	...
	public @ResponseBody Map<String, Object> addTrgterList( @ModelAttribute Map<String, Object> param, ModelMap model) throws Exception {
		Map<String, Object> rsMap = new HashMap<String, Object>();		
		List<Map<String, String>> rsList = cmntyGSetService.getAddTrgterList(param);
		rsMap.put("rsList", rsList);
		rsMap.put("id", param.get("id"));
		return rsMap;
	}
