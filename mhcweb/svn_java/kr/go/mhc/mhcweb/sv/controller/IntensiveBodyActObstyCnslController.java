...
public class IntensiveBodyActObstyCnslController extends DMultiActionController{
	...
	/**
	 * 2단계 판정자 서비스시작 팝업 화면 호출
	 */
	@RequestMapping(value= "/getService_pop.do", method = RequestMethod.GET)
	public String getService_pop(@ModelAttribute Map param, ModelMap model) throws Exception {
		return "web/tg/servicePop";
	}
	 ...
	 * 중강도 운동  종목 공통코드 가져오기
	 */
	@RequestMapping(value= "/getExcsClfCodeList.do", method = RequestMethod.POST)
	public @ResponseBody Map<String,Object> getExcsClfCode(@ModelAttribute Map<String, Object> param, ModelMap model) throws Exception {
		Map<String,Object> rsMap = new HashMap<String,Object>();
		List<Map<String, Object>> rsList = intensiveBodyActObstyCnslService.getExcsClfCodeList(param);
	 ...
	 */
	@RequestMapping(value= "/getRunninSttusHeartRate.do", method = RequestMethod.POST)
	public @ResponseBody Map<String,Object> getRunninSttusHeartRate(@ModelAttribute Map<String, Object> param, ModelMap model) throws Exception {
		Map<String,Object> rsMap = new HashMap<String,Object>();
		List<Map<String, Object>> rsList = intensiveBodyActObstyCnslService.getRunninSttusHeartRate(param);
	 ...
	 * 측정된 중강도 운동 리스트 가져오기
	 */
	@RequestMapping(value= "/getRunningSttusList.do", method = RequestMethod.POST)
	public @ResponseBody Map<String,Object> getRunningSttusList(@ModelAttribute Map<String, Object> param, ModelMap model) throws Exception {
		Map<String,Object> rsMap = new HashMap<String,Object>();
		List<Map<String, Object>> rsList = intensiveBodyActObstyCnslService.getRunningSttusList(param);
	 ...
	 */
	@RequestMapping(value= "/getRunningHrArr.do", method = RequestMethod.POST)
	public @ResponseBody Map<String,Object> getRunningHrArr(@ModelAttribute Map<String, Object> param, ModelMap model) throws Exception {
		Map<String,Object> rsMap = new HashMap<String,Object>();
		List<Map<String, Object>> rsList = intensiveBodyActObstyCnslService.getRunningHrArr(param);

		rsMap.put("rsList", rsList);
		rsMap.put("START_DE", param.get("START_DE"));
		rsMap.put("EXCS_START_TM", param.get("EXCS_START_TM"));
		rsMap.put("EXCS_END_TM", param.get("EXCS_END_TM"));
		rsMap.put("AVG_HEART_RATE", param.get("AVG_HEART_RATE"));
		return rsMap;
	}
