...
public class IntensiveBodyActObstyCnslServiceImpl extends EgovAbstractServiceImpl implements IntensiveBodyActObstyCnslService {
	...
	public List<Map<String, Object>> getExcsClfCodeList(Map<String, Object> param) throws Exception {
		return intensiveBodyActObstyCnslDAO.getExcsClfCodeList(param);
	}
	...
	public List<Map<String, Object>> getRunninSttusHeartRate(Map<String, Object> param) throws Exception {
		return intensiveBodyActObstyCnslDAO.getRunninSttusHeartRate(param);
	}
	...
	public List<Map<String, Object>> getRunningSttusList(Map<String, Object> param) throws Exception {
		return intensiveBodyActObstyCnslDAO.getRunningSttusList(param);
	}
	...
	public List<Map<String, Object>> getRunningHrArr(Map<String, Object> param) throws Exception {
		return intensiveBodyActObstyCnslDAO.getRunningHrArr(param);
	}
}
