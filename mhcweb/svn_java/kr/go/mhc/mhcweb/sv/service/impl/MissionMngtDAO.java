...
public class MissionMngtDAO extends DMultiEgovAbstractMapper{
	...
	public int getMissionMngtListCount(Map<String, Object> param) throws Exception {
		int rsList = selectOne("mhc.web.sv.missionmngt.selectMissionCount", param);
		return rsList;
	}
	...
	public List<Map<String, String>> getMissionMngtList(Map<String, Object> param) throws Exception {
		List<Map<String, String>> rsList = selectList("mhc.web.sv.missionmngt.selectMissionList", param);
		return rsList;
	}
	...
	public Map<String, String> getMissionMngtDtls(Map<String, Object> param) throws Exception {
		Map<String, String> rsMap = selectOne("mhc.web.sv.missionmngt.selectMissionDtls", param);
		return rsMap;
	}
	...
	public List<Map<String, String>> getMissionSelGubun(Map<String, Object> param) throws Exception {
		List<Map<String, String>> rsList = selectList("mhc.web.sv.missionmngt.missionSelGubun", param);
		return rsList;
	}
	...
	public Map<String, String> getSelMission(Map<String, Object> param) throws Exception {
		Map<String, String> rsMap = selectOne("mhc.web.sv.missionmngt.selMission", param);
		return rsMap;
	}
	...
	public List<Map<String, String>> getMissionPostGubun(Map<String, Object> param) throws Exception {
		...
		if("11".equals(param.get("SCLAS_CD")) ) {
			rsList = selectList("mhc.web.sv.missionmngt.missionPostMain", param);
		} else if ("12".equals(param.get("SCLAS_CD")) ) {
			rsList = selectList("mhc.web.sv.missionmngt.missionPostCmnty", param);
		}
		return rsList;
	}
	...
	public Map<String, String> getMissionJoinInquire(Map<String, Object> param) throws Exception {
		...
		if( "11".equals(param.get("SCLAS_CD")) ) {
			rsMap = selectOne("mhc.web.sv.missionmngt.missionJoinInquireMain", param);
		} else if ( "12".equals(param.get("SCLAS_CD")) ) {
			rsMap = selectOne("mhc.web.sv.missionmngt.missionJoinInquireCmntyUserId", param);
		}
		return rsMap;
	}
	...
	public int getMissionInquireSN(Map<String, Object> param) throws Exception {
		int rsInt = selectOne("mhc.web.sv.missionmngt.missionInquireSN", param);
		return rsInt;
	}
	...
	public void insertMission(Map<String, Object> param) throws Exception {
		insert("mhc.web.sv.missionmngt.insertMission", param);
	}
	...
	public void insertMissionGrp(Map<String, Object> param) throws Exception {
		...
		for(int i=0; i<cnt; i++){
			...
			insert("mhc.web.sv.missionmngt.insertMissionGrp", param);
		}	
	}
	...
	public int getSelBoardSn(Map<String, Object> param) throws Exception {
		int rsInt = selectOne("mhc.web.sv.missionmngt.selBoardSn", param);
		return rsInt;
	}
	...
	public void insertCmntyBoard(Map<String, Object> param) throws Exception {
		insert("mhc.web.sv.missionmngt.insertCmntyBoard", param);
	}
	...
	public void insertBoardGrp(Map<String, Object> param) throws Exception {
		...
		for(int i=0; i<cnt; i++){
			...
			insert("mhc.web.sv.missionmngt.insertPostGrp", param);
		}
	}
	...
	public void updateMission(Map<String, Object> param) throws Exception {
		update("mhc.web.sv.missionmngt.updateMission", param);
	}
	...
	public void deleteMissionGrp(Map<String, Object> param) throws Exception {
		delete("mhc.web.sv.missionmngt.deleteMissionGrp", param);
	}
	...
	public void updateCmntyBoard(Map<String, Object> param) throws Exception {
		update("mhc.web.sv.missionmngt.updateCmntyBoard", param);
	}
	...
	public void deletePostGrp(Map<String, Object> param) throws Exception {
		delete("mhc.web.sv.missionmngt.deletePostGrp", param);
	}
	...
	public List<Map<String, String>> getDtlsSelGrp(Map<String, Object> param) throws Exception {
		...
		if("11".equals(param.get("POST_CLF")) ) {
			rsList = selectList("mhc.web.sv.missionmngt.dtlsSelMain", param);
		} else if("12".equals(param.get("POST_CLF")) ) {
			rsList = selectList("mhc.web.sv.missionmngt.dtlsSelCmnty", param);
		}
		return rsList;
	}
	...
	public List<Map<String, String>> getNotSelMainGrp(Map<String, Object> param) throws Exception {
		List<Map<String, String>> rsList = selectList("mhc.web.sv.missionmngt.notSelMainGrp", param);
		return rsList;
	}
	...
	public List<Map<String, String>> getNotSelCmntyGrp(Map<String, Object> param) throws Exception {
		List<Map<String, String>> rsList = selectList("mhc.web.sv.missionmngt.notSelCmntyGrp", param);
		return rsList;
	}
	...
	public List<Map<String, String>> getSelBottomList(Map<String, Object> param) throws Exception {
		List<Map<String, String>> rsList = selectList("mhc.web.sv.missionmngt.selMainBottomList", param);
		return rsList;
	}
	...
	public List<Map<String, String>> getSelReList(Map<String, Object> param) throws Exception {
		List<Map<String, String>> rsList = selectList("mhc.web.sv.missionmngt.selCmntyBottomList", param);
		return rsList;
	}
	...
	public int getCmntyReCnt(Map<String, Object> param) throws Exception {
		int rsList = selectOne("mhc.web.sv.missionmngt.cmntyReCnt", param);
		return rsList;
	}
	...
	public int getCmntyExpCnt(Map<String, Object> param) throws Exception {
		int rsList = selectOne("mhc.web.sv.missionmngt.cmntyExpCnt", param);
		return rsList;
	}
	...
	public List<Map<String, String>> getSelExpressionList(Map<String, Object> param) throws Exception {
		List<Map<String, String>> rsList =selectList("mhc.web.sv.missionmngt.selExpressionList", param);
		return rsList;
	}
	...
	public void insertMissionReply(Map<String, Object> param) throws Exception {
		...
		for(int i=0; i<cnt; i++){
			...
			insert("mhc.web.sv.missionmngt.insertMissionReply", param);
			j += 2;
		}
	}
	...
	public void updatePostYN(Map<String, Object> param) throws Exception {
		update("mhc.web.sv.missionmngt.updatePostYN", param);
	}
	...
	public void updateMissionScore(Map<String, Object> param) throws Exception {
		...
		update("mhc.web.sv.missionmngt.updateMissionScore", param);
	}
	...
	public void insertMissionScore(Map<String, Object> param) throws Exception {
		...
		for(int i=0; i < reCmmntTgrtCnt; i++){
			...
			insert("mhc.web.sv.missionmngt.insertMissionScore", param);
			j += 1;
		}
	...
	public List<Map<String, String>> getSelectAttchFileList(Map<String, Object> param) throws Exception{
		List<Map<String,String>> rsList = selectList("mhc.web.sv.missionmngt.selectAttchFileList", param);		
		return rsList;  
	}
}
