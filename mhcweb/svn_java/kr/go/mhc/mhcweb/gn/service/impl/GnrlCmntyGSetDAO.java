...
@Repository("web.gn.GnrlCmntyGSetDAO")
public class GnrlCmntyGSetDAO extends DMultiEgovAbstractMapper{
	...
	public List<Map<String, String>> getCmntyGList(Map<String, Object> param) throws Exception {		
		List<Map<String,String>> rsList = selectList("mhc.web.gn.gnrlcmntygset.selectcmntyGList", param);		
		return rsList;  
	}
	...
	public List<Map<String, String>> getCmntyGTrgterList(Map<String, Object> param) throws Exception {		
		List<Map<String,String>> rsList = selectList("mhc.web.gn.gnrlcmntygset.selectcmntyGTrgterList", param);		
		return rsList;  
	}
	...
	public Map<String,Object> getNewCmntyGSn(Map<String, Object> param) throws Exception {		
		Map<String,Object> rsMap = selectOne("mhc.web.gn.gnrlcmntygset.selectNewCmntyGSn", param);
		return rsMap;  
	}
	...
	public void getCmntyGInsert(Map<String, Object> param) throws Exception {
		insert("mhc.web.gn.gnrlcmntygset.insertCmntyG", param);
	}
	...
	public void getCmntyGUpd(Map<String, Object> param) throws Exception {
		update("mhc.web.gn.gnrlcmntygset.updateCmntyG", param);
//		update("mhc.web.gn.gnrlcmntygset.updateCmntyGUseNMb", param);
	}
	...
	public void getCmntyGUseN(Map<String, Object> param) throws Exception {
		update("mhc.web.gn.gnrlcmntygset.updateCmntyGUseN", param);
	}
...
//			update("mhc.web.gn.gnrlcmntygset.updateCmntyGTrgterUseN", trgterInfoMap);
			delete("mhc.web.gn.gnrlcmntygset.deleteCmntyGTrgter", trgterInfoMap);
		}
	}
	...
	public List<Map<String, String>> getGclasList() throws Exception {		
		List<Map<String,String>> rsList = selectList("mhc.web.gn.gnrlcmntygset.selectGclasList");		
		return rsList;  
	}
	...
	public List<Map<String, String>> getAddTrgterList(Map<String, Object> param) throws Exception {		
		...
		List<Map<String,String>> rsList = selectList("mhc.web.gn.gnrlcmntygset.selectAddTrgterList", param);		
		return rsList;  
	}
	...
	public void getCmntyGTrgterInsert(Map<String, Object> param) throws Exception {
		...
		Map<String, Object> modalwrapInfoMap = new HashMap<String, Object>();
			for(int i=0; i < modalwrapCnt; i++){
				...
				update("mhc.web.gn.gnrlcmntygset.selectMergeMember", modalwrapInfoMap);
			}
		}
}
