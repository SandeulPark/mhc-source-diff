...
@Repository("web.gn.GnrlPointRankingDAO")
public class GnrlPointRankingDAO extends DMultiEgovAbstractMapper {
	// 포인트 및 랭킹 메세지 조회
	public Map<String, Object> getPointRankingMsg(Map<String, Object> param) throws Exception {
		Map<String, Object> rsMap = selectOne("mhc.web.gn.gnrlpointranking.selectPointRankingMsg", param);
		return rsMap;
	}
	
	// 포인트 및 랭킹 목록 조회
	public List<Map<String, Object>> getPointRankingList(Map<String, Object> param) throws Exception {
		List<Map<String, Object>> rsList = selectList("mhc.web.gn.gnrlpointranking.selectPointRankingList", param);
		return rsList;
	}
	
	// 순위 별 건강포인트 전체 조회
	public List<Map<String, Object>> getRankingAllPointList(Map<String, Object> param) throws Exception {
		List<Map<String, Object>> rsList = selectList("mhc.web.gn.gnrlpointranking.selectRankingAllPointList", param);
		return rsList;
	}
	
	//대상여부_초기화 및 선정 업데이트
	public int updatepymntTrgtY(Map<String, Object> param) throws Exception {
		update("mhc.web.gn.gnrlpointranking.updatePymntTrgtN", param);
		...
		for(int i=0; i<selUserId.length; i++) {
			...
			update("mhc.web.gn.gnrlpointranking.updatePymntTrgtY", param);
			updateCnt ++;
		}
		return updateCnt;
	}
	...
	public Map<String, Object> getStepRankingMsg(Map<String, Object> param) throws Exception {
		Map<String, Object> rsMap = selectOne("mhc.web.gn.gnrlpointranking.selectStepRankingMsg", param);
		return rsMap;
	}
	
	// 걸음수 랭킹 목록 조회
	public List<Map<String, Object>> getStepRankingList(Map<String, Object> param) throws Exception {
		List<Map<String, Object>> rsList = selectList("mhc.web.gn.gnrlpointranking.selectStepRankingList", param);
		return rsList;
	}
}