...
public class GnrlMealDiaryRegController extends DMultiActionController {

	@Resource(name= "web.gn.GnrlMealDiaryRegService")
	private GnrlMealDiaryRegService gnrlmealDiaryRegService;
	...
	public @ResponseBody Map<String, Object> mealDiaryRegList(@ModelAttribute Map<String, Object> param, ModelMap model) throws Exception {
		...
		List<Map<String, Object>> rsList = gnrlmealDiaryRegService.getMealDiaryRegList(param);
	...
	public @ResponseBody Map<String, Object> getMealDiaryExcel(@ModelAttribute Map<String, Object> param, ModelMap model) throws Exception {
		...
		List<Map<String, Object>> melaDiaryData = gnrlmealDiaryRegService.getMealDiaryExcel(param);
