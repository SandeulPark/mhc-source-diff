...
@Repository("web.st.ErrDataSttusDAO")
public class ErrDataSttusDAO extends DMultiEgovAbstractMapper {
    ...
    public List<Map<String, String>> errDataSyncList(Map<String, Object> param) throws Exception {
        List<Map<String, String>> rsList = selectList("mhc.web.st.errdatasttus.errDataSyncList", param);
        return rsList;
    }
    ...
    public List<Map<String, String>> errDataAppVerList(Map<String, Object> param) throws Exception {
        List<Map<String, String>> rsList = selectList("mhc.web.st.errdatasttus.errDataAppVerList", param);
        return rsList;
    }
    ...
    public List<Map<String, String>> errDataModelList(Map<String, Object> param) throws Exception {
        List<Map<String, String>> rsList = selectList("mhc.web.st.errdatasttus.errDataModelList", param);
        return rsList;
    }
    ...
    public List<Map<String, String>> errDataCodeList(Map<String, Object> param) throws Exception {
        List<Map<String, String>> rsList = selectList("mhc.web.st.errdatasttus.errDataCodeList", param);
        return rsList;  
    }
}
