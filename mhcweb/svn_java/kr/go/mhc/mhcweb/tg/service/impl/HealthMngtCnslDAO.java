...
public class HealthMngtCnslDAO extends DMultiEgovAbstractMapper {
	...
	public List<Map<String, Object>> selectDrugInfo(Map<String, Object> param) {
		List<Map<String, Object>> rsList = selectList("mhc.web.tg.healthmngtcnsl.selectDrugInfo", param);
		return rsList;
	}

	public void mergeDrugInfo(Map<String, Object> rsMap) {
		// TODO Auto-generated method stub
		insert("mhc.web.tg.healthmngtcnsl.mergeDrugInfo", rsMap);
	}

	public void deleteDrugInfo(Map<String, Object> param) {
		// TODO Auto-generated method stub
		delete("mhc.web.tg.healthmngtcnsl.deleteDrugInfo", param);
	}

	public void updateDrugBgnDe(Map<String, Object> rsMap) {
		// TODO Auto-generated method stub
		update("mhc.web.tg.healthmngtcnsl.updateDrugBgnDe", rsMap);
	}

	public int selectDrugYn(Map<String, Object> param) {
		// TODO Auto-generated method stub
		return selectOne("mhc.web.tg.healthmngtcnsl.selectDrugYn", param);
	}
}
