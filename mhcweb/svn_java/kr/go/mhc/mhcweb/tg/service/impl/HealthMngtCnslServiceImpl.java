...
public class HealthMngtCnslServiceImpl extends EgovAbstractServiceImpl implements HealthMngtCnslService {
	...
	@Override
	public List<Map<String, Object>> selectDrugInfo(Map<String, Object> param) throws Exception {
		// TODO Auto-generated method stub
		return healthMngtCnslDAO.selectDrugInfo(param);
	}

	@Override
	public void mergeDrugInfo(Map<String, Object> rsMap) throws Exception {
		// TODO Auto-generated method stub
		healthMngtCnslDAO.mergeDrugInfo(rsMap);
	}

	@Override
	public void deleteDrugInfo(Map<String, Object> param) throws Exception {
		// TODO Auto-generated method stub
		healthMngtCnslDAO.deleteDrugInfo(param);
	}

	@Override
	public void updateDrugBgnDe(Map<String, Object> rsMap) throws Exception {
		// TODO Auto-generated method stub
		healthMngtCnslDAO.updateDrugBgnDe(rsMap);
	}

	@Override
	public int selectDrugYn(Map<String, Object> param) throws Exception {
		// TODO Auto-generated method stub
		return  healthMngtCnslDAO.selectDrugYn(param);
	}
}
