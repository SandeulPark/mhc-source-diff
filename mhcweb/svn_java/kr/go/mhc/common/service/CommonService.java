...
public interface CommonService {
	 ...
	 * @throws Exception 
	 */
	public List<Map<String, String>> selectMenuUpCd(Map<String, Object> param) throws Exception;
	 ...
	 * @throws Exception 
	 */
	public List<Map<String, String>> selectMenuCd(Map<String, Object> param) throws Exception;
