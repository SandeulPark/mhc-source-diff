...
public class CommonServiceImpl extends EgovAbstractServiceImpl implements CommonService{
	...
	public List<Map<String, String>> selectMenuUpCd(Map<String, Object> param)
		...
		return cmmnDAO.selectMenuUpCd(param);
	}
	...
	public List<Map<String, String>> selectMenuCd(Map<String, Object> param)
		...
		return cmmnDAO.selectMenuCd(param);
	}

	@Override
	public void insertDownloadRsn(Map<String, Object> param) throws Exception {
		// TODO Auto-generated method stub
		cmmnDAO.insertDownloadRsn(param);
	}
}
